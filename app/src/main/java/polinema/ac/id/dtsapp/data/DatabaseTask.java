...
//    Room database butuh context
    ...
    protected Void doInBackground(Object... objects) {
        ...
        RoomDatabase database = AppDbProvider.getAsynchronousInstance(databaseContext.get());

        // Melemparkan instance database tadi ke event listener untuk diambil DAO-nya nanti
        operationResult = eventListener.runDatabaseOperation(database, objects);
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        eventListener.onDatabaseOperationFinished(operationResult);
    }
}
